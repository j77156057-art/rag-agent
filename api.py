...
@app.post("/api/comfy/cancel/{prompt_id}")
async def comfy_cancel_ep(prompt_id: str, url: str = "http://127.0.0.1:8188"):
    return comfy_cancel(prompt_id, url)
