...
.te-unreal{margin-top:8px;padding-top:8px;border-top:1px solid var(--border);font-size:11px;color:var(--text-muted);display:flex;gap:6px;align-items:center}.te-unreal button{margin-left:auto;background:#17304b;border:1px solid #315c86;color:#b9d8f5;border-radius:4px;padding:4px 7px}.te-unreal-list{max-height:110px;overflow:auto;margin-top:4px;padding:5px;background:var(--bg);font:10px var(--font-mono);color:var(--text-muted)}</style>
